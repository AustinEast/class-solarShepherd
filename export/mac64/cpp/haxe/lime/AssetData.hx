...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/map/Background3.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/map/mapObjects.ase", "assets/images/map/mapObjects.ase");
			type.set ("assets/images/map/mapObjects.ase", Reflect.field (AssetType, "binary".toUpperCase ()));
			path.set ("assets/images/map/mapObjects.png", "assets/images/map/mapObjects.png");
			type.set ("assets/images/map/mapObjects.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/map/Sand_tile.png", "assets/images/map/Sand_tile.png");
			type.set ("assets/images/map/Sand_tile.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/map/tiles.png", "assets/images/map/tiles.png");
			type.set ("assets/images/map/tiles.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/sounds/EnemySpaceshipDestroyed.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sounds/KnockOrBossFire.mp3", "assets/sounds/KnockOrBossFire.mp3");
			type.set ("assets/sounds/KnockOrBossFire.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sounds/MainMenuNavi.mp3", "assets/sounds/MainMenuNavi.mp3");
			type.set ("assets/sounds/MainMenuNavi.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sounds/playerJump.mp3", "assets/sounds/playerJump.mp3");
			type.set ("assets/sounds/playerJump.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sounds/playerSpaceshipDestroyed.mp3", "assets/sounds/playerSpaceshipDestroyed.mp3");
			type.set ("assets/sounds/playerSpaceshipDestroyed.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sounds/powerupPickup.mp3", "assets/sounds/powerupPickup.mp3");
			type.set ("assets/sounds/powerupPickup.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sounds/sounds-go-here.txt", "assets/sounds/sounds-go-here.txt");
			type.set ("assets/sounds/sounds-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/sounds/stunGun.mp3", "assets/sounds/stunGun.mp3");
			type.set ("assets/sounds/stunGun.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
