...
class HXCPP_CLASS_ATTRIBUTES  Graphics_obj : public hx::Object{
	...
	public:
		...
		virtual Void beginGradientFill( ::openfl::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::openfl::_legacy::geom::Matrix matrix,::openfl::_legacy::display::SpreadMethod spreadMethod,::openfl::display::InterpolationMethod interpolationMethod,hx::Null< Float >  focalPointRatio);
		...
		virtual Void lineGradientStyle( ::openfl::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::openfl::_legacy::geom::Matrix matrix,::openfl::_legacy::display::SpreadMethod spreadMethod,::openfl::display::InterpolationMethod interpolationMethod,hx::Null< Float >  focalPointRatio);
