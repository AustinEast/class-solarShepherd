...
class ManagersThreadMessage_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_CSTRING("openfl._legacy.net._URLLoader.ManagersThreadMessage"); }
		::String __ToString() const { return HX_CSTRING("ManagersThreadMessage.") + tag; }
