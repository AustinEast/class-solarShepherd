...
Void DefaultAssetLibrary_obj::loadManifest( ){
{
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			...
			if (((bytes != null()))){
							...
							while((true)){
								...
								struct _Function_7_1{
									inline static bool Block( hx::ObjectPtr< ::DefaultAssetLibrary_obj > __this,Dynamic &asset){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","DefaultAssetLibrary.hx",357,0x0fc48912)
										{
											HX_STACK_LINE(357)
				...
				HX_STACK_LINE(372)
				::haxe::Log_obj::trace(HX_CSTRING("Warning: Could not load asset manifest (bytes was null)"),hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),372,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("loadManifest")));
			}
		}
		}
		catch(Dynamic __e){
			{
				...
				Dynamic e = __e;{
					...
					HX_STACK_LINE(378)
					::haxe::Log_obj::trace(_g2,hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),378,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("loadManifest")));
				}
			}
		}
	}
