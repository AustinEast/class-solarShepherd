...
void Tilesheet_obj::__boot()
{
	...
	lime_tilesheet_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_tilesheet_create"),(int)1);
	lime_tilesheet_add_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_tilesheet_add_rect"),(int)3);
}
