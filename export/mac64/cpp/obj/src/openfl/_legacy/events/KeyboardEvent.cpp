...
::openfl::_legacy::events::Event KeyboardEvent_obj::clone( ){
	...
	HX_STACK_LINE(38)
	return ::openfl::_legacy::events::KeyboardEvent_obj::__new(_g,_g1,_g2,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
}
