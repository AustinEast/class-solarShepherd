...
::openfl::_legacy::filters::BitmapFilter BitmapFilter_obj::clone( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(19)
	return ::openfl::_legacy::filters::BitmapFilter_obj::__new(this->type);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.filters.BitmapFilter"), hx::TCanCast< BitmapFilter_obj> ,sStaticFields,sMemberFields,
