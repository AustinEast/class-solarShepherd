...
::openfl::_legacy::geom::Matrix Matrix_obj::clone( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(32)
	return ::openfl::_legacy::geom::Matrix_obj::__new(this->a,this->b,this->c,this->d,this->tx,this->ty);
}
...
::openfl::_legacy::geom::Point Matrix_obj::deltaTransformPoint( ::openfl::_legacy::geom::Point point){
	...
	HX_STACK_LINE(235)
	return ::openfl::_legacy::geom::Point_obj::__new(((point->x * this->a) + (point->y * this->c)),((point->x * this->b) + (point->y * this->d)));
}
...
::openfl::_legacy::geom::Matrix Matrix_obj::mult( ::openfl::_legacy::geom::Matrix m){
	...
	HX_STACK_ARG(m,"m")
	HX_STACK_LINE(291)
	::openfl::_legacy::geom::Matrix result = ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(293)
...
::openfl::_legacy::geom::Point Matrix_obj::transformPoint( ::openfl::_legacy::geom::Point point){
	...
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(371)
	return ::openfl::_legacy::geom::Point_obj::__new((((point->x * this->a) + (point->y * this->c)) + this->tx),(((point->x * this->b) + (point->y * this->d)) + this->ty));
}
