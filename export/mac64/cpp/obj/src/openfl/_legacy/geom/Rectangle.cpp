...
bool Rectangle_obj::contains( Float x,Float y){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::openfl::_legacy::geom::Rectangle_obj > __this,Float &x){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/geom/Rectangle.hx",39,0xcf1e94dc)
			{
				HX_STACK_LINE(39)
...
bool Rectangle_obj::containsRect( ::openfl::_legacy::geom::Rectangle rect){
	...
	if (((bool((rect->width <= (int)0)) || bool((rect->height <= (int)0))))){
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::openfl::_legacy::geom::Rectangle_obj > __this,::openfl::_legacy::geom::Rectangle &rect){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/geom/Rectangle.hx",55,0xcf1e94dc)
				{
					HX_STACK_LINE(55)
		...
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::openfl::_legacy::geom::Rectangle_obj > __this,::openfl::_legacy::geom::Rectangle &rect){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/geom/Rectangle.hx",59,0xcf1e94dc)
				{
					HX_STACK_LINE(59)
...
::openfl::_legacy::geom::Rectangle Rectangle_obj::intersection( ::openfl::_legacy::geom::Rectangle toIntersect){
	...
	if (((x1 <= x0))){
		HX_STACK_LINE(139)
		return ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
	}
	HX_STACK_LINE(143)
	...
	HX_STACK_LINE(151)
	return ::openfl::_legacy::geom::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
}
...
::openfl::_legacy::geom::Rectangle Rectangle_obj::transform( ::openfl::_legacy::geom::Matrix m){
	...
	HX_STACK_LINE(251)
	return ::openfl::_legacy::geom::Rectangle_obj::__new((tx0 + m->tx),(ty0 + m->ty),(tx1 - tx0),(ty1 - ty0));
}
...
::openfl::_legacy::geom::Point Rectangle_obj::get_bottomRight( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(276)
	return ::openfl::_legacy::geom::Point_obj::__new((this->x + this->width),(this->y + this->height));
}
...
::openfl::_legacy::geom::Point Rectangle_obj::get_size( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(282)
	return ::openfl::_legacy::geom::Point_obj::__new(this->width,this->height);
}
