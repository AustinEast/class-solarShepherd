...
::openfl::geom::Matrix3D Transform_obj::get_matrix3D( ){
	...
	if ((this->__hasMatrix3D)){
		HX_STACK_LINE(84)
		::openfl::_legacy::geom::Matrix matrix = this->__parent->__getMatrix();		HX_STACK_VAR(matrix,"matrix");
		HX_STACK_LINE(85)
...
::openfl::geom::Matrix3D Transform_obj::set_matrix3D( ::openfl::geom::Matrix3D value){
	...
	if (((this->__parent != null()))){
		HX_STACK_LINE(108)
		::openfl::_legacy::geom::Matrix matrix = ::openfl::_legacy::geom::Matrix_obj::__new(value->rawData->__get((int)0),value->rawData->__get((int)1),value->rawData->__get((int)4),value->rawData->__get((int)5),value->rawData->__get((int)12),value->rawData->__get((int)13));		HX_STACK_VAR(matrix,"matrix");
		HX_STACK_LINE(109)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::geom::ColorTransform*/ ,(int)offsetof(Transform_obj,concatenatedColorTransform),HX_CSTRING("concatenatedColorTransform")},
	{hx::fsObject /*::openfl::_legacy::geom::Matrix*/ ,(int)offsetof(Transform_obj,concatenatedMatrix),HX_CSTRING("concatenatedMatrix")},
	{hx::fsObject /*::openfl::_legacy::geom::Rectangle*/ ,(int)offsetof(Transform_obj,pixelBounds),HX_CSTRING("pixelBounds")},
