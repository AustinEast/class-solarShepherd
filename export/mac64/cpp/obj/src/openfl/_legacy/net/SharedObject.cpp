...
Void SharedObject_obj::clear( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(46)
		::String filePath = ::openfl::_legacy::net::SharedObject_obj::getFilePath(this->name,this->localPath);		HX_STACK_VAR(filePath,"filePath");
		HX_STACK_LINE(48)
	...
	HX_STACK_ARG(minDiskSpace,"minDiskSpace")
{
		...
		if ((!(::sys::FileSystem_obj::sys_exists(_g)))){
			HX_STACK_LINE(138)
			::openfl::_legacy::net::SharedObject_obj::mkdir(folderPath);
		}
		HX_STACK_LINE(142)
...
Void SharedObject_obj::mkdir( ::String directory){
{
		...
		struct _Function_1_1{
			inline static bool Block( Array< ::String > &parts){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/net/SharedObject.hx",82,0xecec0fc2)
				{
					HX_STACK_LINE(82)
	...
	HX_STACK_ARG(secure,"secure")
{
		...
		HX_STACK_LINE(176)
		::String filePath = ::openfl::_legacy::net::SharedObject_obj::getFilePath(name,localPath);		HX_STACK_VAR(filePath,"filePath");
		HX_STACK_LINE(177)
