...
Dynamic ScreenMode_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"format") ) { format=inValue.Cast< ::openfl::_legacy::system::PixelFormat >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::system::PixelFormat*/ ,(int)offsetof(ScreenMode_obj,format),HX_CSTRING("format")},
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.system.ScreenMode"), hx::TCanCast< ScreenMode_obj> ,sStaticFields,sMemberFields,
