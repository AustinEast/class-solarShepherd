...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.CompressionAlgorithm"), hx::TCanCast< CompressionAlgorithm_obj >,sStaticFields,sMemberFields,
