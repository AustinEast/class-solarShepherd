...
{
	lime_weak_ref_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_weak_ref_create"),(int)2);
	lime_weak_ref_get= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_weak_ref_get"),(int)1);
}
