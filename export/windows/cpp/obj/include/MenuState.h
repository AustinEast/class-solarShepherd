...
class HXCPP_CLASS_ATTRIBUTES  MenuState_obj : public ::flixel::FlxState_obj{
	...
	public:
		...
		::flixel::text::FlxText _title;
		::flixel::ui::FlxButton _spacePlay;
		::flixel::ui::FlxButton _landPlay;
		virtual Void create( );
		...
		virtual Void goToSpaceState( );
		Dynamic goToSpaceState_dyn();

		virtual Void goToLandState( );
		Dynamic goToLandState_dyn();
