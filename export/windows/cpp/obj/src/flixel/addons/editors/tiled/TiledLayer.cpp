...
::openfl::_legacy::utils::ByteArray TiledLayer_obj::getByteArrayData( ){
	...
	if (((_g == HX_CSTRING("base64")))){
		...
		HX_STACK_LINE(69)
		::openfl::_legacy::utils::ByteArray _g1 = ::flixel::addons::editors::tiled::TiledLayer_obj::base64ToByteArray(chunk);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(69)
		result = _g1;
		HX_STACK_LINE(70)
...
Array< int > TiledLayer_obj::get_tileArray( ){
	...
	if (((this->tileArray == null()))){
		HX_STACK_LINE(220)
		::openfl::_legacy::utils::ByteArray mapData = this->getByteArrayData();		HX_STACK_VAR(mapData,"mapData");
		HX_STACK_LINE(222)
		if (((mapData == null()))){
			HX_STACK_LINE(224)
...
::openfl::_legacy::utils::ByteArray TiledLayer_obj::base64ToByteArray( ::String data){
	...
	HX_STACK_LINE(99)
	::openfl::_legacy::utils::ByteArray output = ::openfl::_legacy::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(output,"output");
	HX_STACK_LINE(102)
