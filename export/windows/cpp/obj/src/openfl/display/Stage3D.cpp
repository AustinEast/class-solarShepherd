	...
	HX_STACK_ARG(context3DRenderMode,"context3DRenderMode")
{
		...
		Void run(){
			...
			{
				HX_STACK_LINE(33)
				_g->__get((int)0).StaticCast< ::openfl::display::Stage3D >()->context3D = ::openfl::display3D::Context3D_obj::__new();
				HX_STACK_LINE(34)
				_g->__get((int)0).StaticCast< ::openfl::display::Stage3D >()->dispatchEvent(::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::CONTEXT3D_CREATE,null(),null()));
			}
			return null();
		}
